...
import TransactionItemAutoComplete from '@/components/desktop/TransactionItemAutoComplete.vue';
...
app.component('TransactionItemAutoComplete', TransactionItemAutoComplete);
